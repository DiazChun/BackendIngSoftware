...
namespace API_SGAMI.Controllers
{
    ...
    public class AsignacionRecursoesController : ControllerBase
    {
        ...
        public AsignacionRecursoesController(SgamiContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<AsignacionRecurso>> PostAsignacionRecurso(AsignacionRecurso asignacionRecurso)
        {
          if (_context.AsignacionRecurso == null)
          {
              return Problem("Entity set 'SgamiContext.AsignacionRecurso'  is null.");
          }
            _context.AsignacionRecurso.Add(asignacionRecurso);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetAsignacionRecurso", new { id = asignacionRecurso.Id }, asignacionRecurso);
        }
        ...
        {
            return (_context.AsignacionRecurso?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
